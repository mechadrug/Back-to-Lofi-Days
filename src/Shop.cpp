...
void Shop::loadItems(){
    ...
    // line1
    itemButtons.push_back(ItemButton(fx,fy,50,50,"../resources/images/shop.png",false,1,5,0));
    itemButtons.push_back(ItemButton(fx+60,fy,50,50,"../resources/images/shop.png",false,1,3,1));
    itemButtons.push_back(ItemButton(fx+120,fy,50,50,"../resources/images/shop.png",false,1,3,2));
    itemButtons.push_back(ItemButton(fx+180,fy,50,50,"../resources/images/shop.png",false,1,3,3));
    itemButtons.push_back(ItemButton(fx+240,fy,50,50,"../resources/images/shop.png",false,1,3,4));
    // line2
    itemButtons.push_back(ItemButton(fx,fy+60,50,50,"../resources/images/shop.png",false,1,3,5));
    itemButtons.push_back(ItemButton(fx+60,fy+60,50,50,"../resources/images/shop.png",false,1,3,6));
    // line3
    itemButtons.push_back(ItemButton(fx,fy+120,50,50,"../resources/images/shop.png",false,1,3,7));
    itemButtons.push_back(ItemButton(fx+60,fy+120,50,50,"../resources/images/shop.png",false,1,3,8));
    itemButtons.push_back(ItemButton(fx+120,fy+120,50,50,"../resources/images/shop.png",false,1,3,9));
    // line4
    itemButtons.push_back(ItemButton(fx,fy+180,50,50,"../resources/images/shop.png",false,5,3,10));
    // line5
    itemButtons.push_back(ItemButton(fx,fy+240,50,50,"../resources/images/shop.png",false,5,3,11));
    itemButtons.push_back(ItemButton(fx+60,fy+240,50,50,"../resources/images/shop.png",false,5,3,12));
    itemButtons.push_back(ItemButton(fx+120,fy+240,50,50,"../resources/images/shop.png",false,1,3,13));
